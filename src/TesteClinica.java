...
public class TesteClinica {
    public static void main(String[] args) {
            //os cadastros estao comentados pq ja estão salvos nos arquivos .txt

        //try {
            CadastroClientes cadastro = new CadastroClientes();
            cadastro.carregarTutores();
            cadastro.carregarAnimais();
            CadastroFuncionarios funcionarios = new CadastroFuncionarios();
            funcionarios.carregarVeterinarios();
            CadastroAgendamentos agendamentos = new CadastroAgendamentos();
            cadastro.listarTutores();

//            Tutor p1 = new Tutor("Maria", "10575614567", "85986970704",
//                    "Av. Bezerra de Menezes, Parquelândia - Fortaleza", Tratamento.MENSALISTA);
//
//            Tutor p2 = new Tutor("Marcio", "76878954369", "85986895932",
//                    "Sargento Hermínio - Fortaleza", Tratamento.TRADICIONAL);
//
//            Animal a1 = new Gato("Lino", "macho", 20, 2, 2025, "SRD", "preto", false);
//            Animal a2 = new Cachorro("Mulan", "femea", 3, 2020, "SRD",
//                    "branca com manchas pretas", "grande");
//            Animal a4 = new Gato("Pingo", "macho", 14, 8, 2017, "SRD", "branco", false);
//
...
//                    new Consulta(LocalDateTime.of(2026, 1, 24, 14, 30), a1, v1)
//            );
//
...
//            agendamentos.listarAgendamentosDoVeterinario(v1);
            ...
            Tela frame = new Tela();
            funcionarios.salvarVeterinarios();
            cadastro.salvarTutores();
            cadastro.salvarAnimais();

        //} catch (VeterinarioIndisponivelException | AnimalIndisponivelException e) {
